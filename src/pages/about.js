...
const words =
  "Hello! I am Arshdeep Singh Virdi, a passionate and driven individual committed to excellence in every endeavor. Currently, I am pursuing a Bachelor of Technology in Computer Science and Engineering (CSE) at SRM Institute of Science and Technology, where I maintain an impressive CGPA of 9.82 as a final year student. Commitment, Passion, and Innovation, these three principles have consistently fueled my journey. My curiosity and enthusiasm for technology motivate me to explore cutting-edge solutions and create impactful projects. Some of my notable experiences include internships in web development, where I developed innovative solutions for companies such as Eshway and Whizz Communications. I have also spearheaded projects like the FinEdge, VigiVault, AI Gallery App, Generative PreTrained Transformer - Teacher, etc - showcasing expertise in Flutter, Firebase, AI integration, MERN stack technologies and machine learning. With my team, I proudly secured 2nd place in the Innosprint D4 Hackathon at CGC College, demonstrating my problem-solving skills and collaborative mindset in high-pressure environments. As a diligent learner and leader, I hold key roles, such as being the Chairperson at GeeksForGeeks SRMIST Chapter and the Joint Secretary of the Student Council, further demonstrating my ability to balance academics, leadership, and passion for community building. Through hard work and a relentless drive to innovate, I aim to make a meaningful impact in the tech field. My skills in programming languages, web development and AI and ML reflect my readiness to excel and adapt to evolving technologies. I look forward to opportunities where I can contribute creatively while growing as a professional in this dynamic field.";
